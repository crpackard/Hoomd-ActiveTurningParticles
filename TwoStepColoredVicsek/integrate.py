...
class vicsek(_integration_method):
    ...
    def __init__(self, group, nlist=None, alpha=1.0, beta=1.0, v0=1.0, delta=0.0, bias=0.0, tau=1.0, sym=2, seed=0):
        ...
        hoomd.util.print_status_line()
        hoomd.context.msg.notice(2, "Setting up vicsek\n")
        ...
        self.sym = sym
        self.seed = seed
        self.metadata_fields = ['group', 'nlist', 'r_cut' 'v0', 'delta', 'tau', 'sym']
    ...
    def get_rcut(self):
        ...
        r_cut_dict = nl.rcut();
        r_cut_dict.set_pair('A','A',self.r_cut);
        return r_cut_dict;
